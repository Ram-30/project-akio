...
class fun(commands.Cog):
    ...
    @commands.cooldown(1, 5, commands.BucketType.user)
    async def ship(self, int : Interaction, user1:nextcord.Member=SlashOption(name="user", description="Mention a user", required=True),user2:nextcord.Member=SlashOption(name="user2", description="Mention another user (leave empty for self)", required=False)):  
